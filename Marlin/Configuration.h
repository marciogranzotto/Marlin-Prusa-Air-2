...
#define CUSTOM_MACHINE_NAME "Prusa Air 2"

// Define this to set a unique identifier for this printer, (Used by some programs to differentiate between machines)
// You can use an online service to generate a random UUID. (eg http://www.uuidgenerator.net/version4)
#define MACHINE_UUID "7cf5fe21-d527-42d2-b49a-928c221d38a6"
...
//#define SWITCHING_EXTRUDER
  ...
  #define SWITCHING_EXTRUDER_SERVO_NR 2
  #define SWITCHING_EXTRUDER_SERVO_ANGLES { 75, 180 } // Angles for E0, E1
...
#define Z_SERVO_ANGLES {60,180} // Z Servo Deploy and Stow angles
...
//
#define Z_PROBE_DEPLOY_HEIGHT 25 // Raise to make room for the probe to deploy / stow
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80.052181,2560,760*1.1}  // default steps per unit for Ultimaker
